...
| **Auto-Update**                    | `qclient node auto-update [enable|disable]`                      | Enables automatic updates for the node application via a cron task.                              |
...
| **Command**                        | **Syntax**                                              | **Description**                                                                                   |
|------------------------------------|--------------------------------------------------------|--------------------------------------------------------------------------------------------------|
<!-- | **Assign Rewards**                 | `qclient node config assign-rewards <Address>`         | Assigns rewards to a specified address for the node.                                             | -->
| **Create**                         | `qclient node config create [name] [--default|-d]`                    | Creates a new configuration set for the node with a name (cannot be 'default'). Optionally assign it to be used by the node with the --default (-d) flag.                              |
...
| **Switch**                         | `qclient node config switch [name]`                    | Switches the active configuration set to the specified name. If no name is provided, lists available options. |
...
| **Signature Check**                | `qclient config signature-check [true|false]`                       | Allows you to persist a signature check disable for all future QClient commands.               |
